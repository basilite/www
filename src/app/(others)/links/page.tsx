...
import { linksItems } from "@/app/lib/config";
...
export default function Links() {
  return (
    <>
      <section className="min-h-screen dark:bg-black dark:text-white selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
        <div className="max-w-[1728px] flex items-start max-lg:flex-col max-lg:gap-8 mx-auto px-4 py-10">
          <div className="w-1/4 max-lg:w-full flex flex-col justify-center gap-4 p-4 rounded-2xl">
            <div className="w-24 h-24 overflow-hidden rounded-full">
              <img src="/logo.png" alt="basilite logo" />
            </div>
            <div className="flex flex-col gap-4">
              <div>
                <h1 className="font-bold text-4xl">Basilite</h1>
              </div>
              <p className="text-black/75 dark:text-white/75 font-normal">
                Your Open-Source Home System
              </p>
